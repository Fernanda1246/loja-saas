...
export default function LoginPage() {
  ...
  async function handleGoogle() {
    ...
    await supabase.auth.signInWithOAuth({
      provider: "google",
      options: {
        redirectTo: `${window.location.origin}/auth/confirmed/callback?redirect=${encodeURIComponent(
          redirect
        )}`,
      },
    });
    ...
    <div className={styles.wrapper}>
      ...
      <main className={styles.right}>
        <div className={styles.formCard}>
          ...
          {errorMsg ? <div className={styles.feedback}>{errorMsg}</div> : null}
          ...
          <button className={styles.provider} onClick={handleGoogle} type="button">
